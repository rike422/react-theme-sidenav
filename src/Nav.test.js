...
describe.only('Nav', () => {
  ...
  it("should take children of NavIcon and NavText and renders it but not NavIcon", () => {
    const wrapper = mount(<Nav id="nav">
        <NavIcon>
  ...
  it("onClick will be called when Nav is clicked and id is passed", () => {
    ...
    const wrapper = mount(<Nav id="nav" onClick={listener}>
        <NavIcon>
          <span className="iconCls">icon</span>
        </NavIcon>
        <NavText>
  ...
  it("NavIcon can be optional", () => {                                        //this should not throw error
                                        const wrapper = mount(<"av d="nav"""">
                                            <NavText>
